...
const mongoURI="mongodb://localhost:27017/insaid?readPreference=primary&appname=MongoDB%20Compass&ssl=false";
...
const connectToMongo=  ()=>{
    ...
    mongoose.connect(mongoURI , ()=>{
        console.log("Connected to mongo successfully insaid");
    })
}
